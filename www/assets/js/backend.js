      ...
      return dbMod.onValue(dbMod.ref(rtdb, path), function (snap) {
        ...
        cb(Object.keys(val).map(function (id) {
          ...
          return {
            ...
            frame: z.frame || null,
            clip: z.clip || null,
            conf: typeof z.conf === 'number' ? z.conf : null,
            mcu: z.mcu || null,
            camModel: z.camModel || null,
            sensors: Array.isArray(z.sensors) ? z.sensors : null,
            flameSource: z.flameSource || null,
            actuators: (z.actuators === false || Array.isArray(z.actuators)) ? z.actuators : null,
            silenced: !!z.silenced,
